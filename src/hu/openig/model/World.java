...
public class World implements ModelLookup {
    ...
    /** Optional settings to change the balance of the game. */
    public final CustomBalanceSettings customBalanceSettings = new CustomBalanceSettings();
    ...
    public XElement saveState() {
        ...
        customBalanceSettings.save(xworld);;
...
//            XElement xdipl = xp.add("diplomacy");
    ...
    public void loadState(XElement xworld) {
        ...
        customBalanceSettings.clear();
        customBalanceSettings.load(xworld);
